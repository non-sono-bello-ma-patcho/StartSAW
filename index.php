...
<body id>
    <div class="global-header">
        <div class="buttondiv">
            ...
            <input type="button" value="login" onclick="loadDiv('templates/loginform.php', 'modalviewer'); showform()">
        </div>
        <div class="modal" id="modalviewer">
        </div>
        <div class="banner">
            <div class="titlediv logishtitle">
                <h1 class="logishtitle big">Herschel</h1>
            </div>
        </div>
    ...
    <svg  viewBox="0 0 1802 500" id="descbg">
        ...
        <!-- Deepest comet level -->
        <g transform="translate(400, 400), rotate(135), scale(3)" class="redcomet">
              <path d="M0,20 L0,100 C0,103.7 5,103.7 5,100 L5,180 C5,183.7 10,183.7 10,180 L10,120 C10,123.7 15,123.7 15,120 L15,110 C15,113.7 20,113.7 20,110 L20,20 Z" fill="#fff05a"></path>
              <path d="M0,20 L0,80 C0,83.7 5,83.7 5,80 L5,90 C5,93.7 10,93.7 10,90 L10,110 C10,113.7 15,113.7 15,110 L15,95 C15,98.7 20,98.7 20,95 L20,20 Z" fill="#ffd25a"></path>
              <path d="M0,20 L0,60 C0,63.7 5,63.7 5,60 L5,80 C5,83.7 10,83.7 10,80 L10,70 C10,73.7 15,73.7 15,70 L15,60 C15,63.7 20,63.7 20,60 L20,20 C20,5 0,5 0,20 Z" fill="#ffaa5a"></path>
        </g>
        <g transform="translate(1700, 80), rotate(45), scale(1)" class="bluecomet">
        ...
        <g transform="translate(1500, 500), rotate(50), scale(0.6)" class="bluecomet">
